import { AnyProcedure, inferProcedureInput, inferProcedureOutput } from './procedure';
import { RootConfig, RootTypes } from './root-config';
 ...
 * @internal
 */
export function createRouterFactory<TRoot extends RootTypes>(
