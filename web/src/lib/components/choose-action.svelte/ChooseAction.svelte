...
<div class="flex flex-1 flex-col items-center justify-center p-8 text-black">
	...
	{#if errorMessage}
		<div
			class="mb-8 flex w-full max-w-2xl items-center gap-4 rounded-lg border-2 border-red-600 bg-red-500/90 p-4"
			role="alert"
		>
	...
	<div class="grid w-full max-w-4xl grid-cols-1 gap-8 lg:grid-cols-2">
		<div
			class="rounded-2xl bg-white/95 p-8 shadow-2xl backdrop-blur-sm transition-all duration-200 hover:-translate-y-1 hover:transform"
		>
			<h2 class="mb-4 flex items-center gap-2 text-2xl font-bold text-indigo-600">
				🎯 Start New Event
			</h2>
			<p class="mb-6 leading-relaxed text-gray-700">
				Set up a new competition event with teams, judges, and awards.
			</p>
		...
		>
			...
			<p class="mb-6 leading-relaxed text-gray-700">
				Join an existing judging session using a link from your judge advisor.
			</p>
