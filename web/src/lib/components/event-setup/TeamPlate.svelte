<script lang="ts">
	...
	let { team, showGrade = true, isSelected = false }: Props = $props();
</script>

<div
	class="team-info min-h-19 0 cursor-move rounded bg-white p-3 shadow-sm transition-all hover:shadow-md"
