	...
	async function processTeamData() {
		const confirmed =
			...
			(await dialogs.showConfirmation({
				title: 'Import Teams',
				message: 'Are you sure you want to import these teams? Any existing teams NOT included in this import will be permanently removed from the system, along with ALL their related rubrics, award rankings, and judging data. Teams that match by team number will keep their existing data. This action cannot be undone.',
				confirmText: 'Import Teams',
				cancelText: 'Cancel',
	...
	<div class="space-y-6">
		...
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
			...
			<div class="space-y-4">
				...
				<p class="h-14 text-sm text-gray-600">
					Download the Excel file from RobotEvents → Event Admin → "Downloads & Links" → "Download Digital Engineering Notebook Links
					report". Select all data in the Excel file (Ctrl+A) and paste it here
				</p>
