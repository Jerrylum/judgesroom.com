<script lang="ts">
	...
	const rubricCriteria = [
		{ id: 'organization', name: 'Organization & Structure', maxScore: 15, description: 'Clear organization, table of contents, dated entries' },
		{ id: 'design_process', name: 'Design Process Documentation', maxScore: 20, description: 'Evidence of iterative design process and improvements' },
...
<div class="h-full overflow-auto p-6">
	<div class="mx-auto max-w-4xl space-y-6">
		...
		{#if selectedTeamId}
			<div class="rounded-lg bg-white p-6 shadow-sm">
				<h3 class="text-lg font-medium text-gray-900 mb-4">Notebook Evaluation</h3>
				<div class="space-y-6">
			...
			<div class="rounded-lg bg-white p-6 shadow-sm">
				<h3 class="text-lg font-medium text-gray-900 mb-4">Review Notes</h3>
				<textarea
			...
			<div class="rounded-lg bg-white p-6 shadow-sm">
				<h3 class="text-lg font-medium text-gray-900 mb-4">Quick Checklist</h3>
